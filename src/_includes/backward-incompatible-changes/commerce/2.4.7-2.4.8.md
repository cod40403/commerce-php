...
Return type for the field `gift_message_available` was changed from `String` to `Boolean!` in the following files:
- app/code/Magento/GiftMessageGraphQl/etc/schema.graphqls
- app/code/Magento/GiftCardGraphQl/etc/schema.graphqls
